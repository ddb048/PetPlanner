...
public class MyUserDetails implements UserDetails {
	...
	/*
	 	All Methods After Here:
	 		...
	 		- have these methods return true manually if you don't need to store info about them
	 		  for your security
	*/
	...
	// credentials are no longer valid b/c you have to set a new pw every couple months
	@Override
